...
const SchoolForm = () => {
    ...
    return (
        <ScrollView style={tw`flex-1 p-6 bg-gray-50`}>
            {/* Title */}
            <Text style={tw`text-3xl font-bold text-center mb-8`}>School Form</Text>

            {/* School Name */}
            <View style={tw`mb-4`}>
                <Text style={tw`text-lg font-semibold mb-2`}>School Name</Text>
                <TextInput
            ...
            <View style={tw`mb-6`}>
                ...
                {['ICSE', 'CBSE', 'IGCSE', 'State', 'IB'].map((syllabus) => (
